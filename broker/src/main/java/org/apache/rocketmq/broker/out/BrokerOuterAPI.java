...
public class BrokerOuterAPI {
    ...
    public List<RegisterBrokerResult> registerBrokerAll(
        ...
        // 创建一个CopyOnWriteArrayList类型的集合，用于保存请求的返回结果
        ...
        if (nameServerAddressList != null && nameServerAddressList.size() > 0) {
            ...
            /**
             * 构造请求体，将携带topic信息的topicConfigTable、版本信息的dataVersion、消费过滤信息集合放入请求体
             */
            ...
            /**
             * 采用线程池方式（即多线程并发）的向所有的NameServer发起注册请求
             */
    ...
    private RegisterBrokerResult registerBroker(
        ...
        /**
         * 通过remotingClient发起同步调用，非单向请求（即需同步的获取结果）
         */
                        ...
                        switch (response.getCode()) {
                            case ResponseCode.SUCCESS: {
                                ...
                                if (body != null) {
                                    ...
                                    // 如果当前broker的dataVersion与NameServer的dataVersion不相等，则表示需继续更新
