...
/**
 * NameServer的配置类：包含NameServer的配置（NameServer 业务参数）
 */
public class NamesrvConfig {
    ...
    /**
     *  rocketmq主目录
     *  可通过-Drocketmq.home.dir=path 或 通过设置环境变量ROCKETMQ_HOME 来配置RocketMQ 的主目录
     */
    private String rocketmqHome = System.getProperty(MixAll.ROCKETMQ_HOME_PROPERTY, System.getenv(MixAll.ROCKETMQ_HOME_ENV));
    /**
     * NameServer 存储KV 配置属性的持久化路径
     * ${rocketmqHome}/namesrv/kvConfig.json
     */
    private String kvConfigPath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "kvConfig.json";
    /**
     * NameServer 默认配置文件路径,不生效。
     * NameServer启动时如果要通过配置文件配置NameServer 启动属性的话，使用-c 选项。
     * ${rocketmqHome}/namesrv/namesrv.properties
     */
