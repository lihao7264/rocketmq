...
/**
 * NettyRemoting抽象类
 * NettyRemotingServer、NettyRemotingClient的子类
 */
                ...
                public void run() {
                    try {
                        ...
                        if (pair.getObject1() instanceof AsyncNettyRequestProcessor) {
                            /**
                             *  如果处理器是异步请求处理器，则调用异步处理的方法asyncProcessRequest
                             *  SendMessageProcessor是一个异步消息处理器
                             */
